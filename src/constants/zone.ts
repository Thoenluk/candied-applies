...
export class Zone {
    ...
    static readonly TRANSMUTATION_WITHOUT_CD = new Zone("TRANSMUTATION_WITHOUT_CD", MapImage.TransmutationWithoutCD, "");
    static readonly TRANSMUTATION_WITH_CD = new Zone("TRANSMUTATION_WITH_CD", MapImage.TransmutationWithCD, "");
